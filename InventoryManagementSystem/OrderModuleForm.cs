...
namespace InventoryManagementSystem
{
    ...
    {
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\C#\Projects\InventoryManagementSystem\Database\InventoryManagementSystemDB.mdf;Integrated Security=True;Connect Timeout=30");
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    //int quantity;
                    //if (!int.TryParse(UDQty.Value.ToString(), out quantity))
                    //{
                    //    MessageBox.Show("Invalid quantity value. Please enter a valid integer.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    //    return;
                    //}
                    ...
                    //{
                    //    MessageBox.Show("Invalid price value. Please enter a valid integer.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    //    return;
                    //}
